...
// UI feature: Undo/Redo history panel (state changes history).
//
// This is NOT "История карточек" (imported verbs history).
// Verbs import history is implemented in js/data/verbHistory.js and UI in verbsListPanel.js.
...
export function featureUndoHistoryPanel(){
  return {
    id: "history",
    install(ctx){
